...
main = do    
    print "----DAY 6----"
    print "Part1_0"
    readInputAndProcess "inputs/day6/input_0.txt" solvePart1
    print "Part1"
    readInputAndProcess "inputs/day6/input_1.txt" solvePart1
    print "Part2_0"
    readInputAndProcess "inputs/day6/input_0.txt" solvePart2
    print "Part2"
    readInputAndProcess "inputs/day6/input_1.txt" solvePart2
